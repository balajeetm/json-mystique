...
* The library can be primarily used as a stand-alone java lib and depends on
    * [Gson - 2.11.0](https://mvnrepository.com/artifact/com.google.code.gson/gson) for json String to Java pojo
      transformations
    * [Jackson - 2.17.3](https://mvnrepository.com/artifact/com.fasterxml.jackson.core/jackson-databind) for json String
...
* For the [Spring](https://spring.io/) fan-boys, Json Mystique also ships a Spring-Starter, which depends on
    * [Spring Boot - 3.4.2](https://docs.spring.io/spring-boot/3.4/index.html)
    * [Spring-Framework - 6.2.2](https://docs.spring.io/spring-framework/reference/6.2/index.html) for IOC
...
[json-mystique](http://repo1.maven.org/maven2/com/balajeetm/mystique/json-mystique/3.0.0/)
___
...
[json-mystique-starter](http://repo1.maven.org/maven2/com/balajeetm/mystique/json-mystique-starter/3.0.0/)
___
...
[gson-utils](http://repo1.maven.org/maven2/com/balajeetm/mystique/gson-utils/3.0.0/)
___
...
[jackson-utils](http://repo1.maven.org/maven2/com/balajeetm/mystique/jackson-utils/3.0.0/)
___
