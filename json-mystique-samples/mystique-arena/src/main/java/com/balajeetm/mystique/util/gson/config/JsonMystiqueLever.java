 ...
 * @author balajeetm
 */
public class JsonMystiqueLever extends JsonLever {
  ...
  /** The instance. */
  private static JsonMystiqueLever INSTANCE;
   ...
   */
  public static JsonMystiqueLever getInstance() {
    return INSTANCE;
  }
   ...
   *
   * @param source the json source which can be Object, Array or a Primitive
   * @param jPath the json array defining the full qualified json path to the field required
  ...
  /**
   * Gets the field of interest for a fully qualified json path represented as a string array.
   *
   * @param source the json source which can be Object, Array or a Primitive
  ...
  /**
   * Creates a new JsonElement (Either JsonObject, JsonArray based on the json path) and sets the
   * field as per the json path provided.
   *
   * @param value the json value that needs to be set to the destination. This can be an Object,
   *     Array or a Primitive
   * @param to the jPath json array defining the full qualified json path to the destination field
   ...
   * @param value the json value that needs to be set to the destination. This can be an Object,
   *     Array or a Primitive
   * @param to jPath the string array defining the full qualified json path to the field required
   * @return the json element created and the field set
   */
   ...
   * Sets the field of a json source.
   *
   * <p>If the json source is null, a new json element is created and the value is then set to the
   * destination. Do not use this method, if multiple threads are setting different fields of the
   * json source. Use the other "setField" methods that use result wrapper instead to be thread
   * safe.
   *
   * @param result the json resource whose field is to be set. Can be null, in which case a new json
   *     element is created as per the jPath
   * @param value the json value that needs to be set to the destination. This can be an Object,
   *     Array or a Primitive
   * @param to the jPath json array defining the full qualified json path to the destination field
   *     where the value must be set
   ...
   * @return the json source
   */
  public JsonElement setField(
      JsonElement result, JsonElement value, Boolean optional, JsonArray to) {
    JsonObject resultWrapper = new JsonObject();
    resultWrapper.add(MysCon.RESULT, result);
  ...
  /**
   * Formats the input date as a json element based on the format configuration.
   *
   * @param date the date
